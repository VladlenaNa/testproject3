           ...
           <Header/>
            <div className="tmdb_content">
                <div className = "info_tmdb">
                    <h2> Hi there!</h2>
                    <p>international focus The Movie Database (TMDB) is a community built movie and TV database. Every piece of data has been added by our amazing community dating back to 2008. TMDb's strong and breadth of data is largely unmatched and something we're incredibly proud of. Put simply, we live and breathe community and that's precisely what makes us different.</p>
                </div>
