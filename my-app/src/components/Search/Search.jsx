...
export default function Search() {
    ...
    return (
        ...
        <div className="search_content">
            <h2>Welcome</h2>
            <h3>Millions of movies, TV shows to discover. Explore now and enjoy!</h3>
            <form className="search_form" action="" method="get">
                <input className="input_name" value={keyword} onChange={get_title} name="s" placeholder="Enter name..."/>
              <img onClick={handleSubmit} className="search_button"src={searchIcon}></img>
            </form>
        </div>
